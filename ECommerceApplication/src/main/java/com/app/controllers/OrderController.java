...
import com.app.payloads.CredentialsDTO;
...
public class OrderController {
	...
	public ResponseEntity<OrderDTO> orderProducts(@Valid @RequestBody CredentialsDTO credentials, @PathVariable String email, @PathVariable Long cartId) {
		OrderDTO order = orderService.placeOrder(credentials.getAddress(), email, cartId);
